...
#if !defined(QMK_KEYS_PER_SCAN) && defined(REGISTER_MULTIPLE_KEYEVENTSS_ENABLED)
#    warning REGISTER_MULTIPLE_KEYEVENTSS_ENABLED needs QMK_KEYS_PER_SCAN defined to have any effect, setting default of 4.
